...
import { COLORS, FONTS, lightGrayThree, primary, SHADOWS, SIZES } from '../constants/theme';
...
const Tabs = () => {
  ...
  const icons = {
    ...
    Eğitimler: 'text-box-check-outline',
      ...
      screenOptions={({ route }) => ({
        ...
        tabBarIcon: ({ focused, color, size }) => {
          ...
          return (
            <View
              style={{
                backgroundColor: focused ? COLORS.primaryDark : '#fff',
                width: 50,
                height: 50,
                zIndex: 1,
                borderRadius: 25,
              ...
              <Icon type={iconType} name={iconName} size={24} color={focused ? 'white' : 'black'} />
              <Text
                style={{
